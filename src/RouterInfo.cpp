...
RouterInfo::RouterInfo() {
    ...
    label_router_name.set_label("路由器名称: " + first_router->get_name());
    label_router_uuid.set_label("路由器 UUID: " + first_router->get_uuid());
...
void RouterInfo::on_dropdown_changed() {
    ...
    label_router_name.set_label("路由器名称: " + router->get_name());
    label_router_uuid.set_label("路由器 UUID: " + router->get_uuid());
